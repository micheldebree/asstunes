...
header:   .byte 13,13,13,13
         .text "Vangelis zou dit niet"
         .text " leuk vinden..."
         .byte 13,13
         .text "Verneukt by Mad B/"
         .text "Rhyme Design."
         .byte 0
//---------------------------------------
bar:      sta length
...
k0b:      .byte $32,$0f,$0d
         ...
         .byte $01
i0c:      .byte $81,$11,$40,$fe

k0c:      .byte $3d,$11,$0a,$07,$04
         .byte $fe
